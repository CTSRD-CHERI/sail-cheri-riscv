...
lemmas register_defs = get_regval_def set_regval_def satp_ref_def tlb48_ref_def tlb39_ref_def
  ...
  utval_ref_def ucause_ref_def uepc_ref_def uscratch_ref_def utvec_ref_def MEPCC_ref_def
  MScratchC_ref_def MTDC_ref_def MTCC_ref_def SEPCC_ref_def SScratchC_ref_def STDC_ref_def
  STCC_ref_def UEPCC_ref_def UScratchC_ref_def UTDC_ref_def UTCC_ref_def DDC_ref_def nextPCC_ref_def
  uccsr_ref_def sccsr_ref_def mccsr_ref_def pmpaddr15_ref_def pmpaddr14_ref_def pmpaddr13_ref_def
  pmpaddr12_ref_def pmpaddr11_ref_def pmpaddr10_ref_def pmpaddr9_ref_def pmpaddr8_ref_def
  pmpaddr7_ref_def pmpaddr6_ref_def pmpaddr5_ref_def pmpaddr4_ref_def pmpaddr3_ref_def
  pmpaddr2_ref_def pmpaddr1_ref_def pmpaddr0_ref_def pmp15cfg_ref_def pmp14cfg_ref_def
  pmp13cfg_ref_def pmp12cfg_ref_def pmp11cfg_ref_def pmp10cfg_ref_def pmp9cfg_ref_def
  pmp8cfg_ref_def pmp7cfg_ref_def pmp6cfg_ref_def pmp5cfg_ref_def pmp4cfg_ref_def pmp3cfg_ref_def
  pmp2cfg_ref_def pmp1cfg_ref_def pmp0cfg_ref_def tselect_ref_def stval_ref_def scause_ref_def
  sepc_ref_def sscratch_ref_def stvec_ref_def sideleg_ref_def sedeleg_ref_def mhartid_ref_def
  marchid_ref_def mimpid_ref_def mvendorid_ref_def minstret_written_ref_def minstret_ref_def
  mtime_ref_def mcycle_ref_def mcountinhibit_ref_def scounteren_ref_def mcounteren_ref_def
  mscratch_ref_def mtval_ref_def mepc_ref_def mcause_ref_def mtvec_ref_def medeleg_ref_def
  mideleg_ref_def mie_ref_def mip_ref_def mstatus_ref_def mstatush_ref_def PCC_ref_def misa_ref_def
  ...
  x2_ref_def x1_ref_def instbits_ref_def nextPC_ref_def PC_ref_def
...
lemma regval_ccsr[simp]:
  "ccsr_of_regval (regval_of_ccsr v) = Some v"
  by (auto simp: regval_of_ccsr_def)
...
lemma liftS_read_reg_MEPCC[liftState_simp]:
  "\<lbrakk>read_reg MEPCC_ref\<rbrakk>\<^sub>S = read_regS MEPCC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_MEPCC[liftState_simp]:
  "\<lbrakk>write_reg MEPCC_ref v\<rbrakk>\<^sub>S = write_regS MEPCC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_MScratchC[liftState_simp]:
  "\<lbrakk>read_reg MScratchC_ref\<rbrakk>\<^sub>S = read_regS MScratchC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_MScratchC[liftState_simp]:
  "\<lbrakk>write_reg MScratchC_ref v\<rbrakk>\<^sub>S = write_regS MScratchC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_MTDC[liftState_simp]:
  "\<lbrakk>read_reg MTDC_ref\<rbrakk>\<^sub>S = read_regS MTDC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_MTDC[liftState_simp]:
  "\<lbrakk>write_reg MTDC_ref v\<rbrakk>\<^sub>S = write_regS MTDC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_MTCC[liftState_simp]:
  "\<lbrakk>read_reg MTCC_ref\<rbrakk>\<^sub>S = read_regS MTCC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_MTCC[liftState_simp]:
  "\<lbrakk>write_reg MTCC_ref v\<rbrakk>\<^sub>S = write_regS MTCC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_SEPCC[liftState_simp]:
  "\<lbrakk>read_reg SEPCC_ref\<rbrakk>\<^sub>S = read_regS SEPCC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_SEPCC[liftState_simp]:
  "\<lbrakk>write_reg SEPCC_ref v\<rbrakk>\<^sub>S = write_regS SEPCC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_SScratchC[liftState_simp]:
  "\<lbrakk>read_reg SScratchC_ref\<rbrakk>\<^sub>S = read_regS SScratchC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_SScratchC[liftState_simp]:
  "\<lbrakk>write_reg SScratchC_ref v\<rbrakk>\<^sub>S = write_regS SScratchC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_STDC[liftState_simp]:
  "\<lbrakk>read_reg STDC_ref\<rbrakk>\<^sub>S = read_regS STDC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_STDC[liftState_simp]:
  "\<lbrakk>write_reg STDC_ref v\<rbrakk>\<^sub>S = write_regS STDC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_STCC[liftState_simp]:
  "\<lbrakk>read_reg STCC_ref\<rbrakk>\<^sub>S = read_regS STCC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_STCC[liftState_simp]:
  "\<lbrakk>write_reg STCC_ref v\<rbrakk>\<^sub>S = write_regS STCC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_UEPCC[liftState_simp]:
  "\<lbrakk>read_reg UEPCC_ref\<rbrakk>\<^sub>S = read_regS UEPCC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_UEPCC[liftState_simp]:
  "\<lbrakk>write_reg UEPCC_ref v\<rbrakk>\<^sub>S = write_regS UEPCC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_UScratchC[liftState_simp]:
  "\<lbrakk>read_reg UScratchC_ref\<rbrakk>\<^sub>S = read_regS UScratchC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_UScratchC[liftState_simp]:
  "\<lbrakk>write_reg UScratchC_ref v\<rbrakk>\<^sub>S = write_regS UScratchC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_UTDC[liftState_simp]:
  "\<lbrakk>read_reg UTDC_ref\<rbrakk>\<^sub>S = read_regS UTDC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_UTDC[liftState_simp]:
  "\<lbrakk>write_reg UTDC_ref v\<rbrakk>\<^sub>S = write_regS UTDC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_UTCC[liftState_simp]:
  "\<lbrakk>read_reg UTCC_ref\<rbrakk>\<^sub>S = read_regS UTCC_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_UTCC[liftState_simp]:
  "\<lbrakk>write_reg UTCC_ref v\<rbrakk>\<^sub>S = write_regS UTCC_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)
...
lemma liftS_read_reg_uccsr[liftState_simp]:
  "\<lbrakk>read_reg uccsr_ref\<rbrakk>\<^sub>S = read_regS uccsr_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_uccsr[liftState_simp]:
  "\<lbrakk>write_reg uccsr_ref v\<rbrakk>\<^sub>S = write_regS uccsr_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_sccsr[liftState_simp]:
  "\<lbrakk>read_reg sccsr_ref\<rbrakk>\<^sub>S = read_regS sccsr_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_sccsr[liftState_simp]:
  "\<lbrakk>write_reg sccsr_ref v\<rbrakk>\<^sub>S = write_regS sccsr_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)

lemma liftS_read_reg_mccsr[liftState_simp]:
  "\<lbrakk>read_reg mccsr_ref\<rbrakk>\<^sub>S = read_regS mccsr_ref"
  by (intro liftState_read_reg) (auto simp: register_defs)

lemma liftS_write_reg_mccsr[liftState_simp]:
  "\<lbrakk>write_reg mccsr_ref v\<rbrakk>\<^sub>S = write_regS mccsr_ref v"
  by (intro liftState_write_reg) (auto simp: register_defs)
