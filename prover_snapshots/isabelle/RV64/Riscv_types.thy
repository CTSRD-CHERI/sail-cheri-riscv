...
datatype ClearRegSet =   GPRegs | FPRegs
...
type_synonym capreg_idx  =" 6 bits "

type_synonym screg  =" 5 bits "
...
record EncCapability  =
  
 EncCapability_perms ::" 16 bits " 

     EncCapability_otype ::" 18 bits " 

     EncCapability_reserved ::" 2 bits " 

     EncCapability_flags ::" 1 bits " 

     EncCapability_internal_E ::" bitU " 

     EncCapability_T ::" 12 bits " 

     EncCapability_B ::" 14 bits " 

     EncCapability_address ::" 64 bits "  



type_synonym mem_meta  =" bool "

type_synonym tagaddrbits  =" 60 bits "
...
type_synonym CapAddrBits  =" 64 bits "

type_synonym CapAddrInt  =" int "

type_synonym CapLenBits  =" 65 bits "

type_synonym CapLen  =" int "

type_synonym CapPermsBits  =" 19 bits "

type_synonym CapFlagsBits  =" 1 bits "
...
record Capability  =
 ...
 Capability_tag ::" bool " 
     ...
     Capability_permit_cinvoke ::" bool " 
...
datatype ext_ptw_lc =   PTW_LC_OK | PTW_LC_CLEAR



datatype ext_ptw_sc =   PTW_SC_OK | PTW_SC_TRAP



record ext_ptw  = 
 ext_ptw_ptw_lc ::" ext_ptw_lc " 
 ext_ptw_ptw_sc ::" ext_ptw_sc "  



datatype ext_ptw_fail =   EPTWF_NO_PERM | EPTWF_CAP_ERR



datatype ext_ptw_error =   AT_CAP_ERR



datatype ext_exc_type =   EXC_LOAD_CAP_PAGE_FAULT | EXC_SAMO_CAP_PAGE_FAULT | EXC_CHERI
...
datatype ext_access_type =   Data | Cap
...
datatype (plugins only: size) ast  =
  ...
  | AUIPCC " (( 20 bits * regidx))"
  | CJAL " (( 21 bits * regidx))"
  | CJALR " (( 12 bits * regidx * regidx))"
  | CGetPerm " ((regidx * regidx))"
  | CGetType " ((regidx * regidx))"
  | CGetBase " ((regidx * regidx))"
  | CGetLen " ((regidx * regidx))"
  | CGetTag " ((regidx * regidx))"
  | CGetSealed " ((regidx * regidx))"
  | CGetOffset " ((regidx * regidx))"
  | CGetAddr " ((regidx * regidx))"
  | CGetFlags " ((regidx * regidx))"
  | CSpecialRW " ((regidx * screg * regidx))"
  | CAndPerm " ((regidx * regidx * regidx))"
  | CSetFlags " ((regidx * regidx * regidx))"
  | CToPtr " ((regidx * regidx * regidx))"
  | CSub " ((regidx * regidx * regidx))"
  | CIncOffset " ((regidx * regidx * regidx))"
  | CIncOffsetImmediate " ((regidx * regidx * 12 bits))"
  | CSetOffset " ((regidx * regidx * regidx))"
  | CSetAddr " ((regidx * regidx * regidx))"
  | CSetBounds " ((regidx * regidx * regidx))"
  | CSetBoundsImmediate " ((regidx * regidx * 12 bits))"
  | CSetBoundsExact " ((regidx * regidx * regidx))"
  | CClearTag " ((regidx * regidx))"
  | CMove " ((regidx * regidx))"
  | Clear " (( 2 bits * 8 bits))"
  | CClear " (( 2 bits * 8 bits))"
  | FPClear " (( 2 bits * 8 bits))"
  | CFromPtr " ((regidx * regidx * regidx))"
  | CBuildCap " ((regidx * regidx * regidx))"
  | CCopyType " ((regidx * regidx * regidx))"
  | CRRL " ((regidx * regidx))"
  | CRAM " ((regidx * regidx))"
  | CTestSubset " ((regidx * regidx * regidx))"
  | CSEQX " ((regidx * regidx * regidx))"
  | CSeal " ((regidx * regidx * regidx))"
  | CCSeal " ((regidx * regidx * regidx))"
  | CUnseal " ((regidx * regidx * regidx))"
  | CSealEntry " ((regidx * regidx))"
  | CInvoke " ((regidx * regidx))"
  | JALR_CAP " ((regidx * regidx))"
  | JALR_PCC " ((regidx * regidx))"
  | LoadDataDDC " ((regidx * regidx * bool * word_width))"
  | LoadDataCap " ((regidx * regidx * bool * word_width))"
  | LoadCapDDC " ((regidx * regidx))"
  | LoadCapCap " ((regidx * regidx))"
  | CLoadTags " ((regidx * regidx))"
  | LoadResDataDDC " ((regidx * regidx * word_width))"
  | LoadResCapDDC " ((regidx * regidx))"
  | LoadResCap " ((regidx * regidx * word_width))"
  | LoadResCapCap " ((regidx * regidx))"
  | LoadResCapMode " ((regidx * regidx * bool * bool))"
  | StoreDataDDC " ((regidx * regidx * word_width))"
  | StoreDataCap " ((regidx * regidx * word_width))"
  | StoreCapDDC " ((regidx * regidx))"
  | StoreCapCap " ((regidx * regidx))"
  | LoadCapImm " ((regidx * regidx * 12 bits))"
  | StoreCapImm " ((regidx * regidx * 12 bits))"
  | StoreCondDataDDC " ((regidx * regidx * word_width))"
  | StoreCondCapDDC " ((regidx * regidx))"
  | StoreCondCap " ((regidx * regidx * word_width))"
  | StoreCondCapCap " ((regidx * regidx))"
  | StoreCondCapMode " ((regidx * regidx * regidx * bool * bool))"
  | AMOSwapCap " ((regidx * regidx * regidx * bool * bool))"
  | ILLEGAL " (word0)"
  | C_ILLEGAL " (half)"
...
type_synonym regtype  =" Capability "
...
record Ext_PTE_Bits  = 
 Ext_PTE_Bits_bits ::"  10 Word.word "  
...
type_synonym ext_fetch_addr_error  =" CapEx "

type_synonym ext_control_addr_error  =" (CapEx * capreg_idx)"

type_synonym ext_data_addr_error  =" (CapEx * capreg_idx)"
...
\<comment> \<open>\<open>val ccsr_of_regval : register_value -> maybe ccsr\<close>\<close>

fun ccsr_of_regval  :: \<open> register_value \<Rightarrow>(ccsr)option \<close>  where 
     \<open> ccsr_of_regval (Regval_ccsr (v)) = ( Some v )\<close> 
  for  v  :: " ccsr "
|\<open> ccsr_of_regval _ = ( None )\<close>


\<comment> \<open>\<open>val regval_of_ccsr : ccsr -> register_value\<close>\<close>

definition regval_of_ccsr  :: \<open> ccsr \<Rightarrow> register_value \<close>  where 
     \<open> regval_of_ccsr v = ( Regval_ccsr v )\<close> 
  for  v  :: " ccsr "
...
definition MEPCC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> MEPCC_ref = ( (|
  name = (''MEPCC''),
  read_from = ((\<lambda> s . (MEPCC   s))),
  write_to = ((\<lambda> v s .  (( s (| MEPCC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition MScratchC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> MScratchC_ref = ( (|
  name = (''MScratchC''),
  read_from = ((\<lambda> s . (MScratchC   s))),
  write_to = ((\<lambda> v s .  (( s (| MScratchC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition MTDC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> MTDC_ref = ( (|
  name = (''MTDC''),
  read_from = ((\<lambda> s . (MTDC   s))),
  write_to = ((\<lambda> v s .  (( s (| MTDC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition MTCC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> MTCC_ref = ( (|
  name = (''MTCC''),
  read_from = ((\<lambda> s . (MTCC   s))),
  write_to = ((\<lambda> v s .  (( s (| MTCC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition SEPCC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> SEPCC_ref = ( (|
  name = (''SEPCC''),
  read_from = ((\<lambda> s . (SEPCC   s))),
  write_to = ((\<lambda> v s .  (( s (| SEPCC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition SScratchC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> SScratchC_ref = ( (|
  name = (''SScratchC''),
  read_from = ((\<lambda> s . (SScratchC   s))),
  write_to = ((\<lambda> v s .  (( s (| SScratchC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition STDC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> STDC_ref = ( (|
  name = (''STDC''),
  read_from = ((\<lambda> s . (STDC   s))),
  write_to = ((\<lambda> v s .  (( s (| STDC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition STCC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> STCC_ref = ( (|
  name = (''STCC''),
  read_from = ((\<lambda> s . (STCC   s))),
  write_to = ((\<lambda> v s .  (( s (| STCC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition UEPCC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> UEPCC_ref = ( (|
  name = (''UEPCC''),
  read_from = ((\<lambda> s . (UEPCC   s))),
  write_to = ((\<lambda> v s .  (( s (| UEPCC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition UScratchC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> UScratchC_ref = ( (|
  name = (''UScratchC''),
  read_from = ((\<lambda> s . (UScratchC   s))),
  write_to = ((\<lambda> v s .  (( s (| UScratchC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition UTDC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> UTDC_ref = ( (|
  name = (''UTDC''),
  read_from = ((\<lambda> s . (UTDC   s))),
  write_to = ((\<lambda> v s .  (( s (| UTDC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>


definition UTCC_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> UTCC_ref = ( (|
  name = (''UTCC''),
  read_from = ((\<lambda> s . (UTCC   s))),
  write_to = ((\<lambda> v s .  (( s (| UTCC := v |))))),
  of_regval = ((\<lambda> v .  Capability_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_Capability v)) |) )\<close>
...
definition uccsr_ref  :: \<open>((regstate),(register_value),(ccsr))register_ref \<close>  where 
     \<open> uccsr_ref = ( (|
  name = (''uccsr''),
  read_from = ((\<lambda> s . (uccsr   s))),
  write_to = ((\<lambda> v s .  (( s (| uccsr := v |))))),
  of_regval = ((\<lambda> v .  ccsr_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_ccsr v)) |) )\<close>


definition sccsr_ref  :: \<open>((regstate),(register_value),(ccsr))register_ref \<close>  where 
     \<open> sccsr_ref = ( (|
  name = (''sccsr''),
  read_from = ((\<lambda> s . (sccsr   s))),
  write_to = ((\<lambda> v s .  (( s (| sccsr := v |))))),
  of_regval = ((\<lambda> v .  ccsr_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_ccsr v)) |) )\<close>


definition mccsr_ref  :: \<open>((regstate),(register_value),(ccsr))register_ref \<close>  where 
     \<open> mccsr_ref = ( (|
  name = (''mccsr''),
  read_from = ((\<lambda> s . (mccsr   s))),
  write_to = ((\<lambda> v s .  (( s (| mccsr := v |))))),
  of_regval = ((\<lambda> v .  ccsr_of_regval v)),
  regval_of = ((\<lambda> v .  regval_of_ccsr v)) |) )\<close>
...
definition x31_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x31_ref = ( (|
  name = (''x31''),
...
definition x30_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x30_ref = ( (|
  name = (''x30''),
...
definition x29_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x29_ref = ( (|
  name = (''x29''),
...
definition x28_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x28_ref = ( (|
  name = (''x28''),
...
definition x27_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x27_ref = ( (|
  name = (''x27''),
...
definition x26_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x26_ref = ( (|
  name = (''x26''),
...
definition x25_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x25_ref = ( (|
  name = (''x25''),
...
definition x24_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x24_ref = ( (|
  name = (''x24''),
...
definition x23_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x23_ref = ( (|
  name = (''x23''),
...
definition x22_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x22_ref = ( (|
  name = (''x22''),
...
definition x21_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x21_ref = ( (|
  name = (''x21''),
...
definition x20_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x20_ref = ( (|
  name = (''x20''),
...
definition x19_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x19_ref = ( (|
  name = (''x19''),
...
definition x18_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x18_ref = ( (|
  name = (''x18''),
...
definition x17_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x17_ref = ( (|
  name = (''x17''),
...
definition x16_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x16_ref = ( (|
  name = (''x16''),
...
definition x15_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x15_ref = ( (|
  name = (''x15''),
...
definition x14_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x14_ref = ( (|
  name = (''x14''),
...
definition x13_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x13_ref = ( (|
  name = (''x13''),
...
definition x12_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x12_ref = ( (|
  name = (''x12''),
...
definition x11_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x11_ref = ( (|
  name = (''x11''),
...
definition x10_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x10_ref = ( (|
  name = (''x10''),
...
definition x9_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x9_ref = ( (|
  name = (''x9''),
...
definition x8_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x8_ref = ( (|
  name = (''x8''),
...
definition x7_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x7_ref = ( (|
  name = (''x7''),
...
definition x6_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x6_ref = ( (|
  name = (''x6''),
...
definition x5_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x5_ref = ( (|
  name = (''x5''),
...
definition x4_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x4_ref = ( (|
  name = (''x4''),
...
definition x3_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x3_ref = ( (|
  name = (''x3''),
...
definition x2_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x2_ref = ( (|
  name = (''x2''),
...
definition x1_ref  :: \<open>((regstate),(register_value),(Capability))register_ref \<close>  where 
     \<open> x1_ref = ( (|
  name = (''x1''),
...
definition get_regval  :: \<open> string \<Rightarrow> regstate \<Rightarrow>(register_value)option \<close>  where 
  ...
  if reg_name = (''MEPCC'') then Some ((regval_of   MEPCC_ref) ((read_from   MEPCC_ref) s)) else
  if reg_name = (''MScratchC'') then Some ((regval_of   MScratchC_ref) ((read_from   MScratchC_ref) s)) else
  if reg_name = (''MTDC'') then Some ((regval_of   MTDC_ref) ((read_from   MTDC_ref) s)) else
  if reg_name = (''MTCC'') then Some ((regval_of   MTCC_ref) ((read_from   MTCC_ref) s)) else
  if reg_name = (''SEPCC'') then Some ((regval_of   SEPCC_ref) ((read_from   SEPCC_ref) s)) else
  if reg_name = (''SScratchC'') then Some ((regval_of   SScratchC_ref) ((read_from   SScratchC_ref) s)) else
  if reg_name = (''STDC'') then Some ((regval_of   STDC_ref) ((read_from   STDC_ref) s)) else
  if reg_name = (''STCC'') then Some ((regval_of   STCC_ref) ((read_from   STCC_ref) s)) else
  if reg_name = (''UEPCC'') then Some ((regval_of   UEPCC_ref) ((read_from   UEPCC_ref) s)) else
  if reg_name = (''UScratchC'') then Some ((regval_of   UScratchC_ref) ((read_from   UScratchC_ref) s)) else
  if reg_name = (''UTDC'') then Some ((regval_of   UTDC_ref) ((read_from   UTDC_ref) s)) else
  if reg_name = (''UTCC'') then Some ((regval_of   UTCC_ref) ((read_from   UTCC_ref) s)) else
  ...
  if reg_name = (''uccsr'') then Some ((regval_of   uccsr_ref) ((read_from   uccsr_ref) s)) else
  if reg_name = (''sccsr'') then Some ((regval_of   sccsr_ref) ((read_from   sccsr_ref) s)) else
  if reg_name = (''mccsr'') then Some ((regval_of   mccsr_ref) ((read_from   mccsr_ref) s)) else
...
definition set_regval  :: \<open> string \<Rightarrow> register_value \<Rightarrow> regstate \<Rightarrow>(regstate)option \<close>  where 
  ...
  if reg_name = (''MEPCC'') then map_option ((\<lambda> v . (write_to   MEPCC_ref) v s)) ((of_regval   MEPCC_ref) v) else
  if reg_name = (''MScratchC'') then map_option ((\<lambda> v . (write_to   MScratchC_ref) v s)) ((of_regval   MScratchC_ref) v) else
  if reg_name = (''MTDC'') then map_option ((\<lambda> v . (write_to   MTDC_ref) v s)) ((of_regval   MTDC_ref) v) else
  if reg_name = (''MTCC'') then map_option ((\<lambda> v . (write_to   MTCC_ref) v s)) ((of_regval   MTCC_ref) v) else
  if reg_name = (''SEPCC'') then map_option ((\<lambda> v . (write_to   SEPCC_ref) v s)) ((of_regval   SEPCC_ref) v) else
  if reg_name = (''SScratchC'') then map_option ((\<lambda> v . (write_to   SScratchC_ref) v s)) ((of_regval   SScratchC_ref) v) else
  if reg_name = (''STDC'') then map_option ((\<lambda> v . (write_to   STDC_ref) v s)) ((of_regval   STDC_ref) v) else
  if reg_name = (''STCC'') then map_option ((\<lambda> v . (write_to   STCC_ref) v s)) ((of_regval   STCC_ref) v) else
  if reg_name = (''UEPCC'') then map_option ((\<lambda> v . (write_to   UEPCC_ref) v s)) ((of_regval   UEPCC_ref) v) else
  if reg_name = (''UScratchC'') then map_option ((\<lambda> v . (write_to   UScratchC_ref) v s)) ((of_regval   UScratchC_ref) v) else
  if reg_name = (''UTDC'') then map_option ((\<lambda> v . (write_to   UTDC_ref) v s)) ((of_regval   UTDC_ref) v) else
  if reg_name = (''UTCC'') then map_option ((\<lambda> v . (write_to   UTCC_ref) v s)) ((of_regval   UTCC_ref) v) else
  ...
  if reg_name = (''uccsr'') then map_option ((\<lambda> v . (write_to   uccsr_ref) v s)) ((of_regval   uccsr_ref) v) else
  if reg_name = (''sccsr'') then map_option ((\<lambda> v . (write_to   sccsr_ref) v s)) ((of_regval   sccsr_ref) v) else
  if reg_name = (''mccsr'') then map_option ((\<lambda> v . (write_to   mccsr_ref) v s)) ((of_regval   mccsr_ref) v) else
